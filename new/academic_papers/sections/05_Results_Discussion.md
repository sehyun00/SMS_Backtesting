...
Table 1은 각 모델의 리밸런싱 주기에 따른 주요 재무 성과 지표(CAGR, Sharpe Ratio, MDD, Total Return)를 보여준다.
...
**Table 1.** Comprehensive Performance Analysis by Rebalancing Period (2015-2024)
...
<!-- [Figure 2] Risk-Return 산점도 삽입 위치 -->
<!-- 권장: images/risk_return_scatter_all.png -->

본 연구에서 주목할 점은 Hybrid 모델의 **성능 일관성(Consistency)**이다. Table 2는 각 모델의 평균 성과를 분석한 결과이다.
...
<!-- [Figure 3] 모델 결과 이미지 삽입 위치 -->
<!-- 권장: images/fig_hybrid_results.png -->
